...
<div id="search_widget" class="col-lg-4 col-md-4 col-sm-4 search-widget" data-search-controller-url="{$search_controller_url}">

	<button class="search-toggle" type="submit">
		<i class="material-icons search">&#xE8B6;</i>
		<!--<span class="hidden-xl-down">{l s='Search' d='Shop.Theme.Catalog'}</span>-->
	</button>
	<form method="get" action="{$search_controller_url}" style="display: none;">
