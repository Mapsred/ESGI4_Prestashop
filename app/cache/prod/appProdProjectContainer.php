...
class appProdProjectContainer extends Container
{
    ...
    protected function getCacheWarmerService()
    {
        ...
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => $this->get('kernel.class_cache.cache_warmer'), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this), 3 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('prestashop.router')), 4 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c, array('/application/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form' => NULL)), 5 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer($this, new \Symfony\Bundle\TwigBundle\TemplateIterator($a, $this->targetDirs[2], array('/application/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form' => NULL))), 6 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine')), 7 => $this->get('main.warmer.cache_warmer'), 8 => new \Csa\Bundle\GuzzleBundle\Description\CacheWarmer\DescriptionCacheWarmer($this->get('csa_guzzle.description_factory'))));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/application/src/PrestaShopBundle/Entity')), 'PrestaShopBundle\\Entity');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_38fa87814fddcc718e5ea987951c77464cca7b8dd48d43ec71edeb44ef198546');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/application/src/PrestaShopBundle/Resources/views', 'PrestaShop');
        $instance->addPath('/application/vendor/csa/guzzle-bundle/src/Resources/views', 'CsaGuzzle');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('JSTZtswuv2kOdb441n8wkt6QpSN4fLtrUOACfo8aChT3JuRtzQVjkuPT');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a956ca50dc909.11411832')), true);
        ...
        return array(
            ...
            'kernel.bundles_metadata' => array(
                'FrameworkBundle' => array(
                    'parent' => NULL,
                    'path' => '/application/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ),
                'SecurityBundle' => array(
                    'parent' => NULL,
                    'path' => '/application/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ),
                'TwigBundle' => array(
                    'parent' => NULL,
                    'path' => '/application/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle',
                ...
                'PrestaShopBundle' => array(
                    'parent' => NULL,
                    'path' => '/application/src/PrestaShopBundle',
                    'namespace' => 'PrestaShopBundle',
                ),
                'TranslationToolsBundle' => array(
                    'parent' => NULL,
                    'path' => '/application/vendor/prestashop/translationtools-bundle',
                    'namespace' => 'PrestaShop\\TranslationToolsBundle',
                ),
                'CsaGuzzleBundle' => array(
                    'parent' => NULL,
                    'path' => '/application/vendor/csa/guzzle-bundle/src',
            ...
            'kernel.secret' => 'JSTZtswuv2kOdb441n8wkt6QpSN4fLtrUOACfo8aChT3JuRtzQVjkuPT',
